...
[cols=",^,^,^,^,^,^,^,^",options="header",]
|====
| Nom        | Estimation du mouvement | Reconnaissance d'image | Android | conception visuel & audio | bdd | QR code | Module SES | Test & Intégration
| Nom Expert | Tarik Graba             | Michel Roux            | Jean-Claude Dufourd   | Dana Diminescu      |     |         |  X         |
