...
Il s'agit d'un petit robot qui recherche et signale la présence des déchets dans un  environnement défini. Celui-ci peut également décider de ramener les déchets à proximité de la poubelle la plus proche lorsque personne n'est présent autour de lui.
Ce projet a pour but de contribue de la propreté de nos environnements. En particulier, le robot présente une optique éducative: il servirait a priori lors d'activités pédagogiques organisées par les enseignants 
...
informs people around him once he found some.
He's also able to bring theses wastes near the closest bin whenever there's nobody around him.
