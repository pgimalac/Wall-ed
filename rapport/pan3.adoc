...
Pour ce qui est du module système embarqué, nous sommes parvenus à faire rouler la voiture de manière autonome. Nous avons décidé que son déplacement durant les phases de recherche de déchets serait aléatoire. Nous sommes parvenus à prendre et enregistrer des photos avec la caméra fournie dans le kit pendant les phases de déplacement pour pouvoir, par la suite, les faire traiter par le module détection de déchets.
