...
===== BLOC QR CODE
Le module "QR code" permet au robot, via une caméra et un bracelet QR code, de connaître l'identité de l'élève l'ayant aidé à jeter un déchet (afin de mettre à jour les statistiques individuelles de l'élève disponible via l'application).
