...
def analyseImage(graph, file_name, h=2340, l=4160, input_layer="Placeholder", output_layer="final_result", label_file="/home/victor/ImageNet_PACT/output_labels.txt"):
    ...
    for k, e in enumerate(L):
        ...
        rapport = e # Rapport de taille entre la nouvelle image et l'ancienne
...
def locateWaste(List):
    ...
    return [getCenter(CBList), getCenter(MetalList), getCenter(PlasticList), getCenter(GlassList)]
