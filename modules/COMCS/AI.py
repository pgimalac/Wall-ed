...
def analyseImage(
    ...
    label_file="/home/adrien/Documents/pact/pact32/modules/COMCS/ImageNet_PACT/output_labels.txt"
):
    ...
    for k in range(len(L)):
        ...
        print("Step " + str(k + 1) + "/" + str(len(L)),
              ...
              file=sys.stderr)  # Affiche l'avancement
        rapport = L[
...
tout(
    "/home/adrien/Documents/pact/pact32/modules/COMCS/ImageNet_PACT/output_graph.pb",
    sys.argv[1])
