...
public class test1 {
	...
	public static void main(String[] args) throws UnknownHostException, IOException, InterruptedException {
		...
		ServerSocket server = new ServerSocket(2346, 10, InetAddress.getByName("127.0.0.1"));
		while(true) {
			try {
	            ...
	            writer.flush();
	            FileOutputStream image = new FileOutputStream("/home/florian/Téléchargements/image.png");
	            int n;
