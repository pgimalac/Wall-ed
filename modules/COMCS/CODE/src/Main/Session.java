...
public class Session {
    ...
    public Session(int id, Eleve[] eleves, String[] bracelets) {
        ...
        String[] args = {"dechetID",    "sessionID",    "braceletID",    "type",
                         "typePropose", "reponseEleve", "heureRamassage"};
        ...
        for (int i = 0; i < this.nbEleves; i++) {
            String[] braceletEleve = {bracelets[i],
                                      Integer.toString(eleves[i].getEleveID())};
    ...
    public void finSession() {
        ...
        String[] values = {Integer.toString(this.sessionID), this.date,
                           this.heureDebut, this.heureFin,
                           Integer.toString(this.nbEleves)};
    ...
    public String getSessionDate() { return this.date; }

    public String getSessionHeureDebut() { return this.heureDebut; }

    public String getSessionHeureFin() { return this.heureFin; }
    ...
    public String getTable_ramassage() { return table_ramassage; }

    public String getTable_eleves() { return table_eleves; }

    public Eleve[] getEleves() { return this.eleves; }
}
