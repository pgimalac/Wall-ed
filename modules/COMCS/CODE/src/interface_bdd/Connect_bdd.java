...
public class Connect_bdd {
    ...
    public void setDataBase(String base) { Connect_bdd.base = base; }
    ...
    public String getConnectionBase() { return Connect_bdd.base; }

    public String getConnectionUser() { return Connect_bdd.user; }
    ...
    public static ResultSetMetaData executeSQL(String commandeSQL) {
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection(
                "jdbc:mariadb://localhost:3306/" + Connect_bdd.base,
                Connect_bdd.user, Connect_bdd.passwd);
    ...
    public static String lastExecuteSQL(String commandeSQL,
