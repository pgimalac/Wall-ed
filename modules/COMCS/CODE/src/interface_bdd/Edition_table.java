...
public class Edition_table {
    ...
    public static void deleteEnregistrement(String table, String idPrimaryKey,
                                            String primaryKey) {
        String query = "DELETE FROM " + table + " WHERE " + idPrimaryKey +
                       " = " + primaryKey;
        Connect_bdd.executeSQL(query);
    }

    public static void modifyEnregistrement(String table, String[] args,
                                            String[] values) {
        String valeurs = "";
        ...
        String query = "UPDATE " + table + "SET " + valeurs + " WHERE " +
                       args[0] + " = " + values[0];
        Connect_bdd.executeSQL(query);
    }
}
