...
matches = [
    "1-7", "2-3", "3-5", "4-3", "5-1", "6-1", "7-0", "8-1", "9-1", "10-3",
    "11-0", "12-3", "13-3", "14-2", "15-2", "16-2", "17-3", "18-2", "19-2",
    "20- 1", "21-2", "22-0", "23-1", "24-5", "25-1", "26-3", "27-4", "28-4",
    "29-4", "30-4", "31-4", "32-1", "33-3", "34-1", "35-1", "36-1", "37-1",
    "38-1", "39-1", "40-1", "41-1", "42-1", "43-1", "44-1", "45-1", "46-1",
    "47-5", "48-1", "49-1", "50-1", "51-3", "52-5", "53-3", "54-5", "55-1",
    "56-5", "57-1", "58-4", "59-5", "60-2", "61-5", "62-0", "63-1", "64-5"
]
    ...
    for i in range(n_annotations):
        ...
        for image_d in images_list:
            if image_d["img_id"] == annotation_id:
                ...
                image_d["annotation"].append(
                    str(annotation_category_id) + " " + str(x) + " " + str(y) +
                    " " + str(width) + " " + str(height) + chr(13))

        #Progress
        sys.stdout.write("Loaded annotation n°" + str(i) + "/" +
                         str(n_annotations))
        sys.stdout.flush()
...
## Save annotations
    ...
    for i in range(len(images_list)):
        ...
        annotation_path = os.path.join(output_directory,
                                       image_d["img_file_name"][:-4] + ".txt")
        with open(annotation_path) as f:
            f.write(image_d["annotation"])
        #Progress
        sys.stdout.write("Saved annotation n°" + str(i) + "/" +
                         str(len(images_list)))
        sys.stdout.flush()
